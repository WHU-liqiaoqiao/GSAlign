...
class EmbeddingHead(nn.Module):
    ...
    def __init__(
        ...
        #添加 轻量 Self-Distillation 分支
        self.head_body_distill = nn.Sequential(
            nn.Conv2d(feat_dim, feat_dim, 1, 1, bias=False),
            get_norm(norm_type, feat_dim),
    ...
    def forward(self, features, targets=None):
        ...
        # 添加 Distillation 分支输出
        distill_feat = self.head_body_distill(pool_feat)  # [B, C, 1, 1]
        distill_feat_flat = distill_feat[..., 0, 0]
        ...
        return {
            ...
            "features": feat,
            "distill_features": distill_feat_flat # 用于self-distillation loss
        }
